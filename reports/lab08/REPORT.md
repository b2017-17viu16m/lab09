...
$ export GITHUB_EMAIL=b2017-17viu16m@yandex.ru
$ alias edit=nano
...
Cозданы конфигурационный файл CPackConfig.cmake и иные необходимые файлы, собраны пакеты (TGZ, RPM, DEB, NSIS, DragNDrop), пакет .tar.gz размещен в директории artifacts
